...
run_name=force_hidden_crossatt2_from_b2_6k_plug_vase_w512_s1000_20260901
run_src=/dev/shm/atomic_force_hidden_crossatt2_b2_6k_20260901
log_path=/mnt/cunchu/zjq/atomic_pi05_logs/${run_name}.log
lock_path=/mnt/cunchu/zjq/atomic_pi05_force_runs/.locks/${run_name}.lock
b2_params=/mnt/cunchu/zjq/atomic_pi05_force_runs/forceonly_zf_zmforecast_plug_vase_afro50k_w512_b2_s6000_future005_20260831/forceonly_zf_zmforecast_plug_vase_afro50k_w512_b2_s6000_future005_20260831/6000/params
...
/mnt/cunchu/zjq/pi0.5_env/.venv/bin/python scripts/train_force_stage_b2.py \
  ...
  --steps 1000 --warmup-steps 100 --peak-lr 3e-6 --decay-steps 1000 --decay-lr 3e-7 \
  ...
  --save-interval 500 --keep-period 1000 --log-interval 10 \
