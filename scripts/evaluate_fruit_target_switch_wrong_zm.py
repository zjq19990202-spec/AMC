#!/usr/bin/env python3
"""Run the multiframe fruit evaluator with prompt-mismatched final zM.

The Context KV cache remains paired with each prompt. Only the final zM batch
is cyclically shifted, while observations, states and flow noise stay fixed.
"""
...
@nnx.jit
def _sample_variants_wrong_zm(model, observation, tokens, masks, noise):
...
if __name__ == "__main__":
    evaluator._sample_variants_layerwise = _sample_variants_wrong_zm
    evaluator.main()
