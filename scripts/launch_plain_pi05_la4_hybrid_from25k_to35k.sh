...
RUN_NAME=${RUN_NAME:-pi05_la4mixed50_atom_if_valid_else_subtask_from25k_to35k_20260902}
...
SOURCE_STEP=/mnt/cunchu/zjq/pi05_method_baselines_20260830/checkpoints/pi05_la4mixed50_atom_if_valid_else_subtask_from20k_to25k_20260901/pi05_la4mixed50_atom_if_valid_else_subtask_from20k_to25k_20260901/25000
...
data_contract_transition=step 0..20000 used subtask_only; step 20000..35000 uses atomic_if_valid_else_subtask
source_full_state=${SOURCE_STEP}
source_step=25000
optimizer_state=restored from source checkpoint
lr_schedule=original warmup1000 peak2.5e-5 cosine_decay30000 floor2.5e-6, continued at global step 25000
