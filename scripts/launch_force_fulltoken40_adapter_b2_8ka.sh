...
run_name=force_fulltoken40_adapter2_frozenb2s6000_plug_vase_w512_s6000_20260901
run_src=/dev/shm/atomic_force_fulltoken40_adapter_b2_20260901
log_path=/mnt/cunchu/zjq/atomic_pi05_logs/${run_name}.log
lock_path=/mnt/cunchu/zjq/atomic_pi05_force_runs/.locks/${run_name}.lock
b1_params=/mnt/cunchu/zjq/atomic_pi05_force_runs/forceonly_zf_zmforecast_plug_vase_afro50k_w512_b2_s6000_future005_20260831/forceonly_zf_zmforecast_plug_vase_afro50k_w512_b2_s6000_future005_20260831/6000/params
checkpoint_root=/mnt/cunchu/zjq/atomic_pi05_force_runs/${run_name}
...
if [[ -e "$checkpoint_root" ]]; then
  echo "checkpoint destination already exists: $checkpoint_root" >&2
  exit 1
fi
...
/mnt/cunchu/zjq/pi0.5_env/.venv/bin/python scripts/train_force_stage_b2.py \
  ...
  --force-improvement-weight 1.0 --force-improvement-margin 0.001 \
