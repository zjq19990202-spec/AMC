...
RUN_NAME=${RUN_NAME:-plain_pi05_atomic_if_valid_else_subtask_fullvision_ddp8_bs256_25k_20260909}
RAM_REPO=${RAM_REPO:?set RAM_REPO to the unique /dev/shm source copy}
PYTHON=/mnt/cunchu/zjq/pi0.5_env/.venv/bin/python
BASE_PARAMS=/mnt/cunchu/zjq/.cache/openpi/openpi-assets/checkpoints/pi05_base/params
...
run_name=${RUN_NAME}
method=stock PI0.5 with full vision and atomic-if-valid prompt routing
comparison_target=LA4VLA-style mixed-vision baseline with identical data and optimization except vision masking
